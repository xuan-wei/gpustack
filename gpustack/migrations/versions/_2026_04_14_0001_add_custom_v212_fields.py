...
MODEL_COLUMNS_TO_ADD = {
    ...
    'scale_pressure_since': sa.Column('scale_pressure_since', UTCDateTime(), nullable=True),
    ...
    'gpu_memory_min_gib': sa.Column('gpu_memory_min_gib', sa.Float(), nullable=True),
    'gpu_memory_max_gib': sa.Column('gpu_memory_max_gib', sa.Float(), nullable=True),
}
