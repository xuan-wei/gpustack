...
class ModelSpecBase(SQLModel, ModelSource):
    ...
    gpu_memory_min_gib: Optional[float] = Field(default=None, ge=0)
    gpu_memory_max_gib: Optional[float] = Field(default=None, ge=0)
    ...
    scale_pressure_since: Optional[datetime] = Field(sa_type=UTCDateTime, default=None)
